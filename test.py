...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_dir', type=str, default='./log/eval1/', help='Directory to put the log data')
    parser.add_argument('--ckpt_step', type=str, default = '4999', help='Checkpoint step to restore')
